...
public class Driver {
    ...
    /*
    Making out 'driver' instance private, so that it is not reachable from outside of any class
    ...
    public static WebDriver getDriver(){
        ...
        //Same driver instance will be returned every time we all Driver.getDriver() method
        return driver;
    }
